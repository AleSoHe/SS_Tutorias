...
\begin{tikzpicture}[line width=0.3mm]
    ...
    \draw[->, line width=0.1mm] (0,-2) -- (0,2.2) node[above] {$f_{2}(t)$};

	% x(t)
	\draw[very thick,color=blue] (-1,0) -- (-1,1);
    \draw[very thick,color=blue, domain=-1:0] plot[id=x] function{1};
	\draw[very thick,color=blue, domain=0:1] plot[id=x] function{-x+1};
